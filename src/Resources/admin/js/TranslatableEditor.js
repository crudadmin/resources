...
var Editor = {
  ...
  hasAllowedFormation: function hasAllowedFormation(element) {
    return CAEditor.rawTranslates.indexOf(element._CAOriginTranslate) > -1;
  },
  isDisabledFormationActionEvent: function isDisabledFormationActionEvent(e, element) {
  ...
  allowFormatingByTranslateType: function allowFormatingByTranslateType(element) {
    ...
    element.addEventListener('keydown', function (e) {
      //Disable formating
      if (_this.isDisabledFormationActionEvent(e, element) === false) {
        e.preventDefault();
      }
    });
  },
  ...
  enableAutoSave: function enableAutoSave(element) {
    element.addEventListener('keyup', function (e) {
      ...
      _Helpers__WEBPACK_IMPORTED_MODULE_0__["default"].removeClass(pencil, CAEditor.pencils.classNameSaved);
...
var Helpers = {
  ...
  htmlspecialcharsDecode: function htmlspecialcharsDecode(str) {
    var map = {
      "&amp;": "&",
      "&lt;": "<",
      "&gt;": ">",
...
var Pencils = {
  ...
  observePencilMovement: function observePencilMovement(element) {
    ...
    var prevPositionKey = null,
      ...
      //We want remove moving class
          ...
          _Helpers__WEBPACK_IMPORTED_MODULE_2__["default"].removeClass(element._CAPencil, _this2.classNameMoving);
        }
    }; //We want turn off moving animation for smother effect


    _Helpers__WEBPACK_IMPORTED_MODULE_2__["default"].addClass(element._CAPencil, this.classNameMoving);
    checkPosition();
  },
  ...
  registerResize: function registerResize() {
    ...
    window.addEventListener('resize', function () {
      ...
      resize = setTimeout(_this3.repaintPencils, 100);
    });
  },
  ...
  bindPosition: function bindPosition(element) {
    ...
    pencil.style.top = (isFixed ? 0 : window.scrollY) + positionY - pencilHeight + 'px'; //Check if element is visible

    pencil.style.display = isHidden ? 'none' : 'block'; //Automatically set zIndex of point

    this.setPencilZindex(element, pencil);
  },
  isPositionFixed: function isPositionFixed(element, pencil) {
    var fixed = false;
  ...
  updateTranslation: function updateTranslation(e) {
    var data = {
      changes: {}
        ...
        value = CAEditor.nodeValue(e); //If is not raw text, we can save unencoded value
    //Because double encodion would be applied from laravel side

    if (_Editor__WEBPACK_IMPORTED_MODULE_1__["default"].hasAllowedFormation(e) === false) {
      value = _Helpers__WEBPACK_IMPORTED_MODULE_2__["default"].htmlspecialcharsDecode(value);
    }

    data.changes[e._CAOriginTranslate] = value; //Clear previous key change
  ...
  hideAllPencils: function hideAllPencils() {
    for (var i = 0; i < CAEditor.matchedElements.length; i++) {
      ...
      if (pencil) {
        _Helpers__WEBPACK_IMPORTED_MODULE_2__["default"].addClass(pencil, Pencils.classNameHidden);
      }
    }
  },
  showAllPencils: function showAllPencils() {
    for (var i = 0; i < CAEditor.matchedElements.length; i++) {
      ...
      if (pencil) {
        _Helpers__WEBPACK_IMPORTED_MODULE_2__["default"].removeClass(pencil, Pencils.classNameHidden);
...
/* harmony import */ var _Editor_Helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Editor/Helpers */ "./src/Resources/js/plugins/Editor/Helpers.js");
/* harmony import */ var _Editor_Editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Editor/Editor */ "./src/Resources/js/plugins/Editor/Editor.js");
/* harmony import */ var _Editor_Navigation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Editor/Navigation */ "./src/Resources/js/plugins/Editor/Navigation.js");
...
(function () {
  window.CAEditor = {
    ...
    init: function init(TAObject) {
      _Editor_Navigation__WEBPACK_IMPORTED_MODULE_3__["default"].init();
    ...
    destroy: function destroy() {
      ...
      _Editor_Editor__WEBPACK_IMPORTED_MODULE_2__["default"].turnOffAllEditors();
      ...
      for (var i = 0; i < elements.length; i++) {
        ...
        if (this.translatedTree[html] !== undefined) {
          ...
          for (var n = 0; n < elements[i].childNodes.length; n++) {
            ...
            html = this.nodeValue(node); //If is only one textnode child in parent,
