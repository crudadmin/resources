...
import RightNavbar from '@components/Partials/RightNavbar.vue';
...
export default {
    ...
    computed: {
        ...mapState('header', ['isActiveMobileMenu']),
    },
    methods: {
        ...mapMutations('header', ['toggleMobileMenu']),
    },
};
</script>
